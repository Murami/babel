/****************************************************************************
** Meta object code from reading C++ file 'LoginDialog.hh'
**
...
#error "The header file 'LoginDialog.hh' doesn't include <QObject>."
...
static const char qt_meta_stringdata_LoginDialog[] = {
    "LoginDialog\0\0createSignInDialog()\0"
    "createLogInDialog()\0"
};
...
void LoginDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->createSignInDialog(); break;
        case 1: _t->createLogInDialog(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
